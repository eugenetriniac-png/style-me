# Builds the Week 2 submission PDF, with no Word and no PDF library:
...
$live = 'https://style-me-five.vercel.app/research'
...
$mock = Img 'ux-mockup.png' 'Wireframe of `/research`, drawn as HTML and rendered to PNG by headless Edge.'
...
$sections = @(
  ...
  '<div class="brk"></div>' + (ConvertFrom-Md 'validation-conversation.md'),
...
$cover = @"
<section class="cover">
<p class="kick">AI-101 · Free-Stack Agentic Builder Studio · Week 2</p>
<h1 class="title">Research + Benchmarking Dashboard</h1>
<p class="sub">Style Me — the Research desk</p>
<p class="who">Eugène Triniac · 23 September 2026</p>
<table class="links">
...
<tr><td>Build Discipline Packet, before coding</td><td>Section 1 — committed as <code>b2de5cd</code>, before the first line of Week 2 code</td></tr>
...
<tr><td>Supabase evidence — table <code>research_records</code></td><td>Section 3</td></tr>
<tr><td>Software tests (min. 3) and iteration log</td><td>Section 4</td></tr>
<tr><td><strong>Human validation conversation</strong> — required this week</td><td>Section 5</td></tr>
<tr><td>Coding-agent prompt log (min. 5)</td><td>Section 6</td></tr>
<tr><td>Research itself — 12 competitors, 5 global benchmarks, 7 Mexico findings, 8 risks, every claim sourced and dated</td><td>Live on <code>/research</code></td></tr>
...
<title>Style Me — Week 2 Submission — Eugène Triniac</title>
<style>
...
$pdf = Join-Path $root 'Style-Me-Week2-Eugene-Triniac.pdf'
